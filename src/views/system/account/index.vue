      ...
      <el-form ref="queryForm" class="pl20 pr20 pt20" label-width="100px" :model="queryForm" :inline="true">
        <div class="query-item">
          <div class="left-query">
            ...
            <el-form-item label="时间" prop="workingTime">
              <el-date-picker
                v-model="workingTime"
                class="w35 ft12"
                type="daterange"
